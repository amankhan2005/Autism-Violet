    ...
    <div className="bg-[#faf9ff]">
      ...
      <section className="py-24 text-center">
        <Container>
          ...
          >
            Learning{" "}
            <em className="italic text-orange-500">Resources</em>
          </motion.h1>
          ...
          >
            Autism Violet provides helpful resources, guides, and tools to
            support parents in understanding autism and helping their child grow
            with confidence.
          </motion.p>
        </Container>
      </section>
        ...
        <Container>
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            >
              <img
                src={resourceImg}
                alt="Parent exploring learning resources and guides"
              ...
              >
                ...
                <div>
                  <p className="text-[13px] font-semibold text-[#1a0a3b] m-0">
                    Expert-curated
                  </p>
                  <p className="text-[11px] text-[#7b6fa0] m-0">
                    Trusted by families
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#1a0a3b] leading-[1.15] mb-5">
                Empowering Parents{" "}
                <em className="italic text-orange-500">with Knowledge</em>
              </h2>
              <p className="text-[#5a4e72] text-[15px] leading-relaxed">
                At Autism Violet, we believe that informed parents create
                stronger outcomes. Our resources are designed to provide clear,
                practical, and effective guidance that helps families support
                their child's development every day.
              </p>
            </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <h2 className="font-playfair text-[clamp(26px,6vw,42px)] font-bold text-white leading-[1.2] tracking-tight mb-4">
              Explore Helpful{" "}
              <em className="italic text-orange-300">Resources Today</em>
            </h2>

            <p className="text-white/65 text-[14px] md:text-[15px] leading-relaxed max-w-[440px] mx-auto mb-8">
              Discover practical tools and expert guidance from Autism Violet to
              better support your child's journey.
            </p>
